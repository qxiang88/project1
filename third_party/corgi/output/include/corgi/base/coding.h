...
#ifndef CORGI_CORE_CODING_H_
#define CORGI_CORE_CODING_H_

#include "corgi/base/raw_coding.h"
...
extern bool GetVarint32(Slice *input, uint32 *value);
extern bool GetVarint64(Slice *input, uint64 *value);
