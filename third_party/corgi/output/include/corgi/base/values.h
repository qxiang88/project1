...
class Value {
 ...
 private:
  ...
  CG_DISALLOW_COPY_AND_ASSIGN(Value);
};
...
class FundamentalValue : public Value {
 ...
 private:
  ...
  CG_DISALLOW_COPY_AND_ASSIGN(FundamentalValue);
};
...
class StringValue : public Value {
 ...
 private:
  ...
  CG_DISALLOW_COPY_AND_ASSIGN(StringValue);
};
...
class BinaryValue: public Value {
 ...
 private:
  ...
  CG_DISALLOW_COPY_AND_ASSIGN(BinaryValue);
};
...
class DictionaryValue : public Value {
 ...
 private:
  ...
  CG_DISALLOW_COPY_AND_ASSIGN(DictionaryValue);
};
...
class ListValue : public Value {
 ...
 private:
  ...
  CG_DISALLOW_COPY_AND_ASSIGN(ListValue);
};
