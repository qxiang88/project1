...
//
#ifndef CORGI_STRINGS_STRCAT_H_
#define CORGI_STRINGS_STRCAT_H_
...
class AlphaNum {
 public:
  ...
  AlphaNum(const Slice &pc) : piece_(pc) {}  // NOLINT(runtime/explicit)
  AlphaNum(const string &str)          // NOLINT(runtime/explicit)
      : piece_(str) {}

  Slice::size_type size() const { return piece_.size(); }
  const char *data() const { return piece_.data(); }
  Slice Piece() const { return piece_; }
 ...
 private:
  ...
  CG_DISALLOW_COPY_AND_ASSIGN(AlphaNum);
};
...
//    of a mix of raw C strings, Slices, strings, bool values,
//    and numeric values.
//
...
string StrCat(const AlphaNum &a) CG_MUST_USE_RESULT;
string StrCat(const AlphaNum &a, const AlphaNum &b) CG_MUST_USE_RESULT;
string StrCat(const AlphaNum &a, const AlphaNum &b,
              const AlphaNum &c) CG_MUST_USE_RESULT;
string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
              const AlphaNum &d) CG_MUST_USE_RESULT;

namespace internal {

// Do not call directly - this is not part of the public API.
string CatPieces(std::initializer_list<Slice> pieces);
void AppendPieces(string *dest, std::initializer_list<Slice> pieces);
...
string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
              ...
              const AV &... args) CG_MUST_USE_RESULT;
