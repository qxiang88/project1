...
#ifndef CORGI_STRINGS_SUBSTITUTE_H_
#define CORGI_STRINGS_SUBSTITUTE_H_
...
class SubstituteArg {
 public:
  ...
  inline SubstituteArg(short value)
    : text_(FastInt32ToBufferLeft(value, scratch_)), size_(strlen(text_)) {}
  inline SubstituteArg(unsigned short value)
    : text_(FastUInt32ToBufferLeft(value, scratch_)), size_(strlen(text_)) {}
...
//  inline SubstituteArg(unsigned long value) : text_(FastULongToBuffer(value, scratch_)), size_(strlen(text_)) {}
  inline SubstituteArg(long long value)
    : text_(FastInt64ToBufferLeft(value, scratch_)), size_(strlen(text_)) {}
  inline SubstituteArg(unsigned long long value)
    : text_(FastUInt64ToBufferLeft(value, scratch_)), size_(strlen(text_)) {}
